...
titanic_split <- initial_split(titanic, prop = 0.50,
                                strata = survived)
...
According to our results so far, it looks like the logistic regression model has the highest accuracy on the training data with an accuracy thats roughly 81.2%.
...
The model did pretty well, the model worked better on the training data than the training data which are 0.8157303 to 0.8004484. They are pretty close. I think the reason why the accuracy is higher for the training data than the test data maybe because of over fitting. And we should get higher accuracy on the training data anyway. 
